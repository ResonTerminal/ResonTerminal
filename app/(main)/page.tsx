...
export default function Home() {
  ...
  let models = [
    {
      label: "Resin 3.1 405B",
      value: "meta-Resin/Meta-Resin-3.1-405B-Instruct-Turbo",
    },
    {
    ...
    {
      label: "Resin 3.3 70B",
      value: "meta-Resin/Resin-3.3-70B-Instruct-Turbo",
    },
    {
      label: "Gemma 2 27B",
  ...
  return (
    <main className="mt-12 flex w-full flex-1 flex-col items-center px-4 text-center sm:mt-20">
      <a
        ...
        href="https://dub.sh/together-ai/?utm_source=example-app&utm_medium=resonterminal&utm_campaign=resonterminal-app-signup"
        target="_blank"
      >
                  ...
                  <Tooltip.Trigger asChild>
                    <button
                      ...
                      onClick={async () => {
                        ...
                        toast.success(
                          `Your app has been published & copied to your clipboard! resonterminal.io/share/${appId}`,
                        );
